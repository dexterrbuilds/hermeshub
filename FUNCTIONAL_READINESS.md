...
| Business onboarding | Not built. Schema supports owner assignment later. | Manual/operator-created beta businesses. | Business signup, verification, service management, hours, photos, bookings, analytics. |
| Verification | `verification_records` schema; verification status displayed. | Operator process for setting verified beta businesses. | Admin workflows, evidence capture, expiry/review cycles, audit trail. |
